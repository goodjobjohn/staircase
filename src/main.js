 // STAIRCASE VARIABLES
  ...
  const listHTML = `<div class="list">
                      <div class="title" contenteditable="true" data-text="+ Add title"></div><div class="list-delete close" contenteditable="false"></div>                         
                    </div>`;
  ...
  const addItem = `<input type="text" class="add-item" placeholder="+ Add item">`;
  ...
  function loadStaircase(listData, listContainer) {
    ...
    const markup = listData.map((list) => {
      return `<div class="list"><div class="title" contenteditable="true" data-text="+ Add title">${list.title}</div><div class="list-delete close" contenteditable="false"></div>
                ${renderItems(list.items)}
                <input type="text" class="add-item" placeholder="+ Add item">
              </div>`
    }).join('');
